// Esta clase será la plantilla para crear varios gatitos.
...
public class Gatito { //Definimos nuestra clase "Gatito". Esta clase nos ayudará a darle características generales a nuestros gatitos.
		...
		//Ahora crearemos métodos para consultar los datos de nuestro gatito.(Getters)
	    ...
	    // Ahora crearemos los métodos para consultar los datos del gatito.(Setters)
	    ...
	    //Método void main para ejecutar la aplicación Java
	    public static void main(String[] args) {
			
	    	Gatito gatito1 = new Gatito();//Creación del objeto dentro de la clase Gatito
